...
objTar=_sobjGrp createUnit["LOP_AM_Infantry_Rifleman",_objvPos,[],0,"CAN_COLLIDE"];publicVariable "objTar";[objTar]call InsH;[objTar]call InsU;[objTar]call InsG;objTar setVariable["NOAI",1,false];objTar disableAI "path";
