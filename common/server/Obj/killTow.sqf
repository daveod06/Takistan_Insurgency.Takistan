...
_objvPos=selectRandom[[6218,6282,0.2],[3554,10000,0.2]];
_objvPos=[_objvPos,random 1000,3500,1,0,60*(pi/180),0,[]]call BIS_fnc_findSafePos;
objTar=createVehicle["Land_Vysilac_FM",_objvPos,[],0,"CAN_COLLIDE"];publicVariable "objTar";
