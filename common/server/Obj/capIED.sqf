...
objTar=_sObjGrp createUnit["LOP_AM_Infantry_Rifleman",_objPos,[],0,"CAN_COLLIDE"];publicVariable "objTar";[objTar]call InsH;[objTar]call InsU;[objTar]call InsG;objTar setVariable["NOAI",1,false];objTar disableAI "path";
...
_objGrp=[_nObjPos,SIDE_INS,(configfile >>"CfgGroups">>"East">>"SovietArmy_OKSVA">>"Infantry">>"SovietArmy_OKSVA__infantry_fire_team")]call BIS_fnc_spawnGroup;
