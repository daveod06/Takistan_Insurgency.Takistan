...
if(!_addaction)then{_EVcustomRP=player getVariable "EVcustomRP";_allowsquadSpawn=player getVariable "EVallowSquadSpawn";}else{
_EVcustomRP=player getVariable "AAcustomRP";_allowsquadSpawn=player getVariable "AAallowSquadSpawn";};
...
if(count BRS_spawnPoints==0)then{exitBRS=TRUE;}else{
BRS_selectSpawn=0;BRS_currentSpawn=(BRS_spawnPoints select BRS_selectSpawn);0=[]call BRS_RP;};}else{
exitBRS=TRUE;sleep 0.2;};
