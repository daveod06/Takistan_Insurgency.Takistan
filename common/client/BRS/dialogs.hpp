class BRS_dialog {
	...
	class BRS_spawn: BRSbuttonSpawn {
		...
		class BRS_button_OpenMap: BRS_subButton {
			...
			action="ctrlShow[30055,true];ctrlShow[30054,false];_nil=[]spawn{if(BRS_mapClose)then{null=[false]execVM ""common\client\BRS\BRS_map\map_close.sqf"";}else{null=[true]execVM ""common\client\BRS\BRS_map\map_close.sqf"";};}";
		};
		class BRS_button_CloseMap: BRS_subButton {
			...
			colorText[]={0,0,0,1};
			action="ctrlShow[30054,true];ctrlShow[30055,false];_nil=[]spawn{if(BRS_mapClose)then{null=[false]execVM ""common\client\BRS\BRS_map\map_close.sqf"";}else{null=[true]execVM ""common\client\BRS\BRS_map\map_close.sqf"";};}";
		};
