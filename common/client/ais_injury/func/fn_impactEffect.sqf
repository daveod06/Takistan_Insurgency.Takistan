...
if(_strength>5)then{_strength=4.0+(random 1.0)};
_power=_strength+4;
...
//if(_a2cc==1) then
//{
//    "colorCorrections" ppEffectAdjust [0.9,1,0,[0.1,0.1,0.1,-0.1],[1,1,0.85,_color],[1,0.1,0,0]];
//}
//else
//{
...
if(_a2cc==1)then{"colorCorrections"ppEffectAdjust[0.9,1,0,[0.1,0.1,0.1,-0.1],[1,1,0.85,0.4],[1,0.1,0,0]];}else{
